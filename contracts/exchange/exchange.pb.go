...
// Source currency is USD, others will be counted from it
// base_currency = "USD"
...
const file_exchange_exchange_proto_rawDesc = "" +
	...
	"\vto_currency\x18\x02 \x01(\tR\n" +
	"toCurrency\x12\x12\n" +
	"\x04rate\x18\x03 \x01(\x02R\x04rate\"\xb8\x01\n" +
	"\x15ExchangeRatesResponse\x12@\n" +
	"\x05rates\x18\x01 \x03(\v2*.exchange.ExchangeRatesResponse.RatesEntryR\x05rates\x12#\n" +
	"\rbase_currency\x18\x02 \x01(\tR\fbaseCurrency\x1a8\n" +
	"\n" +
	"RatesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value:\x028\x012\xb0\x01\n" +
	"\x0fExchangeService\x12D\n" +
	"\x10GetExchangeRates\x12\x0f.exchange.Empty\x1a\x1f.exchange.ExchangeRatesResponse\x12W\n" +
	"\x1aGetExchangeRateForCurrency\x12\x19.exchange.CurrencyRequest\x1a\x1e.exchange.ExchangeRateResponseB\x1dZ\x1bcontracts/exchange;exchangeb\x06proto3"
